          ...
          <div class="container">
            ...
            <div class="container" id="MainText">
                ...
                <p>
                    ...
                    looking forward to great new meal ideas. Originally I was going to also include a bunch of my personal hobbies to write about. I shortened the original list to
                    only include boarding now. When I started building this site I was originally including a bunch more, but decided against it. Later if I wish to go down that rabbit 
